...
| Card Slot | Ore | Metal | Energy | Data | Science | Biomass | Nanites | Time Est. |
|-----------|-----|-------|--------|------|---------|---------|---------|-----------|
| **Extractor** | 50 | - | - | - | - | - | - | 2 min |
...
| Habitat T1 | 0.3 biomass/sec | Consumes 1.0 energy/sec |
...
| Habitat T2 | 0.8 biomass/sec | +166% |
...
Wonder-leaning resources: **Science**, **Biomass**, balanced resource usage.

| Card Slot | Wonder Variant | Ore | Metal | Energy | Data | Science | Biomass | Nanites |
|-----------|---------------|-----|-------|--------|------|---------|---------|---------|
...
| Card Slot | Dread Variant | Ore | Metal | Energy | Data | Science | Biomass | Nanites |
|-----------|--------------|-----|-------|--------|------|---------|---------|---------|
...
| Card Slot | Ore | Metal | Energy | Data | Science | Biomass | Nanites |
|-----------|-----|-------|--------|------|---------|---------|---------|
...
- **Wonder Victory (World-Seeding Protocol)**: ~10M ore, ~5M metal, ~2M energy, ~1M science, ~500K biomass
